...
function AddComment()
    ...
    elseif file_type == "lua" then
        ...
        vim.cmd("echo 'This is an unknown file type'")
...
function AddParenteses()
    ...
    local updated_line_content = string.sub(line_content, 1, col_number) .. comment_string .. string.sub(line_content, col_number + 1)

    vim.fn.setline(line_number, updated_line_content)

    vim.fn.cursor(line_number, col_number + #comment_string)
