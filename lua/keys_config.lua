...
vim.api.nvim_set_keymap('i', 'asd', '<Esc>:lua AddComment()<CR> i', {noremap = true, silent = true})
-- vim.api.nvim_set_keymap('i', '<C-a>', '<Esc>:BufferLineCyclePrev<CR>i', {noremap = true, silent = true})
-- vim.api.nvim_set_keymap('i', '<C-d>', '<Esc>:BufferLineCycleNext<CR>i', {noremap = true, silent = true})
...
vim.api.nvim_set_keymap('v', '>', '>gv', {noremap = true, silent = true})
-- vim.api.nvim_set_keymap('v', '<C-k>', '<Esc>:m .-2<CR>==gv', {noremap = true, silent = true})
-- vim.api.nvim_set_keymap('v', '<C-j>', '<Esc>:m .+1<CR>==gv', {noremap = true, silent = true})
...
-- vim.api.nvim_set_keymap('n', 'dd', 'ddi', {noremap = true, silent = true})
...
vim.api.nvim_set_keymap('n', '<C-a>', ':BufferLineCyclePrev<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-d>', ':BufferLineCycleNext<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-s>', ':BufferLineCloseOthers<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-j>', '<A-#>', {noremap = true, silent = true})
